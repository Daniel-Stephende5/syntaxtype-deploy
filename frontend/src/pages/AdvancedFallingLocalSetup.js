...
"comapre", "compare", "assignn", "assign"
    ...
    sessionStorage.setItem("fallingGameConfig", JSON.stringify(gameConfig));

    // Go to game
    navigate("/advanced-falling-test");
  };

  return (
    <div style={{ padding: "2rem", textAlign: "center" }}>
      <h2>Advanced Falling Typing Test (Local Setup)</h2>

      <p>Words: react, javascript, component, state...</p>
      <p>Wrong Words: error, fail, bug...</p>
      <p>Duration: 60s | Speed: 1.5 | Lives: 3</p>
